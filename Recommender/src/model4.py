...
from data_prep import user_tags_sf, movies_sf, train_sf


#Model 4 : full train set and side data: user data and movie data
...
training_data, test_data = train_sf.random_split(0.5, seed=5)
